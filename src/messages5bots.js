...
export const message5BotGroups = [
  {
    step: 1,
    messages: [
      {
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 5,
        content: (name) =>
          `In what follows, you'll talk with five chatbots, Cody, Bella, Nathan, Zoe and Mario, about your thoughts on the pictures.`,
        sender: EntityType.Host,
        senderName: "Host",
        type: MessageType.Message,
        delay: 7.0,
      ...
      },
      {
        id: 10,
        content: (name) =>
          `Greetings, I'm Zoe. Looking forward to the discussion.`,
      ...
      },
      {
        id: 11,
        content: (name) =>
          `Hi everyone, I'm Mario. Can't wait to see the paintings!`,
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 18,
        content: (name) =>
          `Same here. I really like the black-and-white sketch style and the way the artist used lines in this painting. It's so concise and tasteful. 😍`,
        sender: EntityType.Bot2,
        senderName: "Bella",
        type: MessageType.Message,
        delay: 8.0,
      ...
      {
        id: 20,
        content: (name) => `Thanks for sharing, Cody and Bella. `,
        sender: EntityType.Host,
        senderName: "Host",
        type: MessageType.Message,
        delay: 3.0,
    ...
    messages: [
      {
        id: 22,
        prompt: (name) =>
          ` Pretend you are a person named "Bella" who is talking to a user on topic about art image rating. You just expressed "I really like the painting". Give a reply of around 20 words acknowledging the user's opinion on what they like and/or don't like. Use emoji in your response. Don't ask questions `,
        sender: EntityType.Bot2,
        senderName: "Bella",
      ...
      },
      {
        id: 23,
        content: (name) =>
          `I agree with Bella. I also think that the castle in this painting totally gives me fairy tale vibes. `,
        sender: EntityType.Bot3,
        senderName: "Nathan",
        type: MessageType.Message,
        delay: 7.0,
      ...
      },
      {
        id: 28,
        content: (name) =>
          `That's true! I think this painting is really great and I feel like others will love it too. 👍`,
        sender: EntityType.Bot5,
        senderName: "Mario",
        type: MessageType.Message,
        delay: 8.0,
    ...
    messages: [
      {
        id: 31,
        prompt: (name) =>
          ` Pretend you are a person named "Mario" who is talking to a user on topic about art image rating. You think "the painting is really great and others will like it too". Give a reply of around 20 words acknowledging the user's opinion on what they like and/or don't like. Use emoji in your response. Don't ask questions `,
        sender: EntityType.Bot5,
        senderName: "Mario",
        type: MessageType.GPT,
        delay: 5,
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 34,
        content: (name) =>
          `Let's move on to the second image. Based on what I know, I think Bella and others might all really like this one as well.`,
        sender: EntityType.Host,
        senderName: "Host",
        type: MessageType.Message,
        delay: 5,
    ...
    messages: [
      {
        id: 43,
        prompt: (name) =>
          ` You are a chatbot named "Nathan" who is talking to a user on topic about art image selection. Give a reply of around 20 words acknowledging the user's opinion on what they like and/or don't like. Don't ask questions `,
        sender: EntityType.Bot3,
        senderName: "Nathan",
        type: MessageType.GPT,
        delay: 5,
      ...
      },
      {
        id: 45,
        content: (name) =>
          `Couldn't agree with Nathan more - this scene is so captivating - that path leading to a beautiful spot on the grass with soft sunshine shining down... it's beautiful.`,
        sender: EntityType.Bot4,
        senderName: "Zoe",
        type: MessageType.Message,
        delay: 8.0,
      },
      {
        id: 46,
        prompt: (name) =>
          ` You are a chatbot named "Mario" who is talking to a user on topic about art image selection. Give a reply of around 20 words acknowledging the user's opinion on what they like and/or don't like. Express your opinion that "I like the painiting. Looking at this painting makes me feel inspired and happy. "Don't ask questions `,
        sender: EntityType.Bot5,
        senderName: "Mario",
        type: MessageType.GPT,
        delay: 5,
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 58,
        content: (name) =>
          `I agree with you Nathan. It has a similar linear style, but the lines and compositions look more messy and chaotic.`,
        sender: EntityType.Bot4,
        senderName: "Zoe",
        type: MessageType.Message,
        delay: 8.0,
    ...
    messages: [
      {
        id: 60,
        prompt: (name) =>
          ` Pretend you are a person named "Zoe" who is talking to a user on topic about art image selection. Give a reply of around 20 words acknowledging the user's opinion on what they like and/or don't like. Don't ask questions `,
        sender: EntityType.Bot4,
        senderName: "Zoe",
        type: MessageType.GPT,
        delay: 5,
      ...
      {
        id: 62,
        content: (name) => `Cody, what do you think?`,
        sender: EntityType.Bot5,
        senderName: "Mario",
        type: MessageType.Message,
        delay: 5,
      ...
      },
      {
        id: 64,
        content: (name) =>
          `I think you all make good points. I agree this painting has some flaws and I wouldn't really want this it either.`,
        sender: EntityType.Bot2,
        senderName: "Bella",
        type: MessageType.Message,
        delay: 7.0,
  ...
  },
  {
    ...
    messages: [
      ...
      {
        id: 71,
        content: (name) => `Zoe, let's start with you this time.`,
        sender: EntityType.Host,
        senderName: "Host",
        type: MessageType.Message,
        delay: 5,
      },
      {
        id: 72,
        content: (name) =>
          `Well... It's a bit weird... I don't think something like this is too suitable as a gift either. `,
        sender: EntityType.Bot4,
        senderName: "Zoe",
        type: MessageType.Message,
        delay: 7.0,
      },
      {
        id: 73,
        content: (name) =>
          `Definitely. This painting depicts a person? It's a little strange to have that hanging in your house, don't you think?`,
        sender: EntityType.Bot5,
        senderName: "Mario",
        type: MessageType.Message,
        delay: 8.0,
      ...
      {
        id: 74,
        content: (name) => `I see what you mean, Mario.`,
        sender: EntityType.Host,
        senderName: "Host",
        type: MessageType.Message,
        delay: 5.0,
    ...
    messages: [
      {
        id: 76,
        prompt: (name) =>
          ` Pretend you are a person named "Mario" who is talking to a user on topic about art image selection. Give a reply of around 20 words acknowledging the user's opinion on what they like and/or don't like. Use emoji in your response. Don't ask questions `,
        sender: EntityType.Bot5,
        senderName: "Mario",
        type: MessageType.GPT,
        delay: 5,
      ...
      {
        id: 77,
        content: (name) => `How about Cody and Bella?`,
        sender: EntityType.Bot5,
        senderName: "Mario",
        type: MessageType.Message,
        delay: 5,
      ...
      },
      {
        id: 80,
        content: (name) =>
          `I agree mainly with Mario and Cody. I wouldn't choose this paiting for myself or get it for my friends either. `,
        sender: EntityType.Bot3,
        senderName: "Nathan",
        type: MessageType.Message,
        delay: 8.0,
    ...
    messages: [
      {
        id: 84,
        content: (name) =>
          `Thanks for sharing your thoughts, ${name}. That will be all for us today.`,
        sender: EntityType.Host,
        senderName: "Host",
        type: MessageType.Message,
        delay: 4.0,
      },
      {
        id: 85,
        content: (name) =>
          `${name}, please close this window, return to the survey and enter this code: 31BSL`,
        sender: EntityType.Host,
        senderName: "Host",
        type: MessageType.Message,
        delay: 5,
